# VelocityLink User Manual

## 📱 Overview

**VelocityLink** is an ultra-fast, local-first connectivity suite that connects your **Android phone** and **Windows PC** over WiFi. Transfer files, sync clipboard, control your PC remotely, and more — all without internet!
...
2. Files are saved to Android's VelocityLink folder
...
- Check Windows Firewall allows VelocityLink
